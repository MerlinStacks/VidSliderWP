...
class Wp_Vids_Reel_Loader {
     ...
     *
     * @since    1.0.0
     * @param    string               $hook_name          The name of the WordPress action that is being registered.
     ...
     *
     * @since    1.0.0
     * @param    string               $hook_name          The name of the WordPress filter that is being registered.
